...
import {DEFAULT_AVATAR, EMAIL_VERIFICATION_ENABLED, DRIVER_INIT_RATING} from 'src/environments/environment.prod';
...
export class AuthService {
    ...
    register(email, password, name, phoneNumber, isAccepted) {
    ...
    getPhone() {
        const user = this.getUserData();
        return this.db.object('profile/' + user.uid + '/profile');
    }
